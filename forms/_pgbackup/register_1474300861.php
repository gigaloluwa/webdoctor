...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
      <div class="container">
        <div id='cssmenu'>
          <ul>
            <li><a href="../index.php">webdoctor.com.ng</a></li>
        ...
        <div class="container-fluid" >
           <form method="POST" action="../functions/fn_register.php" name='lendr_registration' id='lendr_registration'>
            <table class='table-responsive table table-condensed'>
                <tr class="segment_lead"><td colspan='4'><label>Personal Information</label></td></tr>
                ...
                <tr> <td colspan="4"><button type="btn" id="submit_btn" class="btn btn-danger">Submit</button></td></form>
                </tr>
            </table>
        </div>
      </div>
